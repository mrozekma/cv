...
def cv(handler):
	...
	term.add('work-history',      'work-history',      'drx',      1477259577, "The places I've worked and the things I did while I was there")
	term.add('personal-projects', 'personal-projects', 'drx',      1477259577, "Things nobody paid me to do. Much more interesting, on the whole")
