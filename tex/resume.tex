...
\work{microsemi}{Microsemi}{Software Developer}{2010 - 2016}{
	...
	\item Developed an OpenSSL engine wrapping our whitebox cryptography implementations so they could be used transparently by any application that uses OpenSSL.
...
\work{arxan-defense-systems}{Arxan Defense Systems}{Software Security Analyst}{2009 - 2010}{
	...
	\item Developed WhiteboxRSA, an RSA implementation that hides the key to frustrate recovery even when the implementation is fully under the attacker's control.
}
