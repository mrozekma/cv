...
\begin{paracol}{ {{ num_skills }} }
	...
	\begin{cvparagraph}
	\skill{.9}{Extensive experience with C, Python, Typescript, and scripting.}
	\skill{.6}{Experience with C++, Java, and Rust.}
	...
	\skill{.7}{Experience with React, Vue, Vite, Webpack, Yarn, and other modern web development tooling.}
	\end{cvparagraph}
	\jinja endif
\switchcolumn
	\jinja if tools
...
\begin{cventries}
\jinja if owl
\work{Owl Cyber Defense}{Principal Software Engineer}{2024 - Present}{
	\item Implemented new protocol adapters and features in a commercial data diode and a government CDS.
	\item Automated common build and test procedures.
}
\jinja endif

\jinja if mercury
\work{Mercury}{Senior Principal Software Engineer}{2016 - 2024}{
